...
type PERSON struct {
	...
	NAME           sq.StringField `ddl:"type=VARCHAR(256)"`
	EMAIL          sq.StringField `ddl:"type=VARCHAR(255)"`
	PASSWORD       sq.StringField `ddl:"type=VARCHAR(255) default='password'"`
...
type COUNTRY struct {
	sq.TableStruct
	COUNTRY_ID sq.NumberField `ddl:"primarykey identity"`
